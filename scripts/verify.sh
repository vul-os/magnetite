#!/usr/bin/env bash
# =============================================================================
# scripts/verify.sh — verify a downloaded Magnetite release artifact, fail-closed.
#
...
#     name as a regex — every "." in "magnetite-0.1.0-linux-x86_64" is a wildcard
...
# USAGE
# ─────
#   scripts/verify.sh --tag v0.1.0 magnetite-0.1.0-linux-x86_64
#   scripts/verify.sh --tag v0.1.0 --attest magnetite-0.1.0-linux-x86_64
#   scripts/verify.sh --repo vul-os/magnetite --tag v0.1.0 --out ~/Downloads ASSET
...
SELFTEST_ARTIFACT="magnetite-web-9.9.9.tar.gz"
...
trap cleanup EXIT
TMPDIR_V="$(mktemp -d "${TMPDIR:-/tmp}/magnetite-verify.XXXXXX")"
