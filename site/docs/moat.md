...
> **Internal engineering spec.** This is the frozen-interface contract
> agents and contributors build against, written for implementers. For an
> overview aimed at users, see [Overview](#overview) or
