...
> **This is the intent, not a status report.** For what's actually built
> today vs. specified, see the [Status](#status) ledger or the landing
> page's status table — this document is the redesign's own source spec and
> program backlog.
