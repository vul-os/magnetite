...
<text x="450" y="68" fill="var(--dv-ink-3)" text-anchor="middle" font-size="12.5">may not name a provider-specific type</text>
<line x1="30" y1="98" x2="870" y2="98" stroke="var(--accent)" stroke-width="1.6" stroke-dasharray="6 5"/>
<text x="450" y="92" fill="var(--accent)" text-anchor="middle" font-size="12" letter-spacing="1.8">— magnetite-seams · TRAITS ONLY —</text>
...
<g text-anchor="middle" font-size="12" fill="var(--dv-ink-faint)">
...
<text x="30" y="212" fill="var(--dv-ink-faint)" font-size="12" letter-spacing="1.6">OPTIONAL ADAPTERS — FEATURE-GATED, NEVER REQUIRED</text>
...
<text x="30" y="284" fill="var(--dv-ink-3)" font-size="12.5">Every default works with no network, no chain and no account — which is why CI runs fully offline.</text>
</g>
</svg>
...
<text x="44" y="72" fill="var(--accent)" font-size="12.5" letter-spacing="1.6">INSIDE THE RECORD</text>
<rect x="52" y="90" width="150" height="42" rx="7" fill="none" stroke="var(--dv-border-2)"/>
<text x="127" y="108" fill="var(--dv-ink-2)" text-anchor="middle" font-size="12.5">keyboard · gamepad</text>
<text x="127" y="123" fill="var(--dv-ink-faint)" text-anchor="middle" font-size="12">LocalDeviceInput</text>
<rect x="250" y="90" width="150" height="42" rx="7" fill="none" stroke="var(--accent)"/>
<text x="325" y="108" fill="var(--dv-ink)" text-anchor="middle" font-size="12.5">ordered command</text>
<text x="325" y="123" fill="var(--accent)" text-anchor="middle" font-size="12">Deterministic</text>
<rect x="52" y="164" width="348" height="46" rx="7" fill="none" stroke="var(--dv-border-2)"/>
<text x="226" y="184" fill="var(--dv-ink-2)" text-anchor="middle" font-size="12.5">ReplayLog → verify_replay</text>
<text x="226" y="200" fill="var(--dv-ink-faint)" text-anchor="middle" font-size="12">re-simulate · compare hashes · locate divergence</text>
<text x="226" y="240" fill="var(--mg-live)" text-anchor="middle" font-size="13">is_replay_verifiable() → true</text>
<text x="226" y="262" fill="var(--dv-ink-3)" text-anchor="middle" font-size="12.5">Tampering can be PROVEN from the record alone.</text>
<!-- the boundary -->
<line x1="450" y1="30" x2="450" y2="300" stroke="var(--mg-bnd)" stroke-width="2" stroke-dasharray="7 6"/>
<text x="450" y="22" fill="var(--mg-bnd)" text-anchor="middle" font-size="12" letter-spacing="1.6">VERIFICATION STOPS HERE</text>
<!-- attested side -->
...
<text x="492" y="72" fill="var(--mg-bnd)" font-size="12.5" letter-spacing="1.6">OUTSIDE THE RECORD</text>
<rect x="500" y="90" width="150" height="42" rx="7" fill="none" stroke="var(--dv-border-2)" stroke-dasharray="3 3"/>
<text x="575" y="108" fill="var(--dv-ink-2)" text-anchor="middle" font-size="12.5">camera · IMU</text>
<text x="575" y="123" fill="var(--dv-ink-faint)" text-anchor="middle" font-size="12">no producer in tree</text>
<rect x="698" y="90" width="150" height="42" rx="7" fill="none" stroke="var(--mg-bnd)"/>
<text x="773" y="108" fill="var(--dv-ink)" text-anchor="middle" font-size="12.5">signed assertion</text>
<text x="773" y="123" fill="var(--mg-bnd)" text-anchor="middle" font-size="12">Attested</text>
<rect x="500" y="164" width="348" height="46" rx="7" fill="none" stroke="var(--dv-border-2)"/>
<text x="674" y="184" fill="var(--dv-ink-2)" text-anchor="middle" font-size="12.5">rate limit → signature → PlausibilityGate</text>
<text x="674" y="200" fill="var(--dv-ink-faint)" text-anchor="middle" font-size="12">"not physically reachable" is all it can reject</text>
<text x="674" y="240" fill="var(--mg-bnd)" text-anchor="middle" font-size="13">is_replay_verifiable() → false</text>
<text x="674" y="262" fill="var(--dv-ink-3)" text-anchor="middle" font-size="12.5">A plausible fabricated event passes every check.</text>
</g>
