      ...
      <div className="admin-dashboard">
        ...
        <main className="admin-main">
          <header className="admin-header">
            ...
            <p>Platform financial overview and payout management</p>
          </header>
          ...
          <div className="stats-grid">
            ...
            <div className="stat-card">
              <span className="stat-icon">💼</span>
              <div className="stat-info">
                <span className="stat-label">Platform Fees (5%)</span>
          ...
          <section className="dashboard-card payouts-section">
                  ...
                  <tr key={txn.id}>
                    ...
                    <td>
                      <span className={`type-badge ${txn.type}`}>
                        {txn.type === 'game_fee' ? 'Game Fee' : 'Payout'}
                      </span>
                    </td>
                    <td>{txn.user}</td>
                    <td>{txn.game}</td>
