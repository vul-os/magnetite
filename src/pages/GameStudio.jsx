...
export default function GameStudio() {
  ...
  const handleDeploy = async (e) => {
    ...
    setDeploying(true);
    try {
      const game = await api.games.create(formData);
    ...
    <Layout>
      <div className="game-studio">
        <header className="studio-header">
          <h1>Game Studio</h1>
          <p>Connect your GitHub repository and configure your game for deployment</p>
        </header>

        <div className="studio-grid">
          <section className="studio-card github-card">
            <h2>GitHub Integration</h2>
            <p className="card-description">Connect your game's GitHub repository to enable automatic deployments</p>
          ...
          <section className="studio-card config-card">
            ...
            <p className="card-description">Configure your game's metadata and pricing</p>
            ...
            <form className="config-form" onSubmit={handleDeploy}>
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  <label>Price per Session (USDC)</label>
                  <input
                    type="number"
                    step="0.01"
                    min="0"
